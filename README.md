# 샘 알트만 오픈AI GPT-4 발표 :tada:   
  
### -AI가 사회를 재구성할 것이며 위험을 인정 이는 조금 두려운 일  
...
### 뉴스 요약  
- 2023년 8월 17일 ABC방송의 샘 알트만의 인터뷰 관한 뉴스이다.  
GPT-4의 출시와 새로운 소프트웨어 프레임워크 'Evals' 관한 소개와 멀티모달 기능, 다국어 지원 및 언어 능력개선에 대한 내용을 설명 또한 사회적 대응과 AI의 미래에 대한 부분에 대하여 인터뷰를 하였다.
  
### 느낀 점
- 기사를 내용을 읽으며 AI 기술력이 매우 빠르게 성장하고 있다는 것을 느꼈고 조만간 언어의 장벽이 없어질 것 같다는 생각이 들었습니다. 또한 ChatGPT 기능을 잘 활용하면 자기개발을 하는것에 엄청난 도움이 될 것 같습니다.      
...
### 뉴스 요약
- 이 기사에서 샘 알트만은 GPT-4가 우리 사회를 재구성할 수 있는 잠재력을 가지고 있다고 말했습니다. 그는 GPT-4가 우리의 삶을 획기적으로 개선할 수 있는 잠재력을 가지고 있지만, 그로 인해 발생할 수 있는 위험에 대해서도 경고했습니다. 그는 GPT-4를 안전하고 책임감 있게 사용하기 위해 모두가 노력해야 한다고 말했습니다.

### 느낀 점
- 어릴 때 부터 어머니의 영향을 받아 인문학을 소중히 하였고, 손에서 놓은 적이 없었으며, 항상 주변사람들에게 소중히 해야한다고 하며 계몽운동을 하였지만 너무 어리다는 이유로 의견이 무시당하는 경험들이 떠올랐습니다. 하지만 인문학, 특히 철학이 정말로 중요하기 때문에 모두의연구소를 기점으로 해서라도 다시 열심히 분발하여 사람들의 인식을 변화하게 할 수 있도록 노력하겠습니다.
